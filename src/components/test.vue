        ...
        <div class="flex flex-col justify-between w-[566px] h-[200px] p-1 pl-0">
            ...
            <div class="flex flex-nowrap justify-between items-end">
                ...
                <span v-if="discount !== 0"
                    class="inline-flex justify-center items-center gap-[10px] py-1 px-2 h-[26px] rounded-md bg-[#219653] text-[#FFFFFF] text-[13px] font-medium leading-[18px] tracking-[0.26px]">{{
                        discount }}%
                    off</span>
            </div>
            <!-- forth row -->
