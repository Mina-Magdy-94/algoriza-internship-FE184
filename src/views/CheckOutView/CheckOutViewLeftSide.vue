<template>
        <div class="w-[810px] rounded-md">
            ...
            <CheckOutViewCard img-src="security-user.svg" title="Room 1"
                subtitle="2 adults, 1 double bed and 1 twin bed, Non-smoking" styling-of-title="text-[#FFFFFF]" styling-of-slot-root="p-[32px] pb-[40px]">
                <div class="pb-[40px] h-[208px]">
                    <div class="w-[500px] h-[196px] flex flex-col justify-between">
                        ...
                        <div class="h-[20px] flex justify-start">
                            <input type="checkbox" id="recieve-alerts">
            ...
            <CheckOutViewCard img-src="card-tick 1.svg" title="Payment options"
                ...
                <section class="h-[330px] w-[536px] flex flex-col justify-between">
                    ...
                    <div class="h-[66px] flex flex-col justify-between">
                        <label 
                            class="h-[20px] text-[#181818] text-[14px] font-semibold leading-[19.6px] tracking-[0.28px]">
                        ...
                        <div class="h-[42px] flex justify-start items-center">
                            <select 
                                ...
                                <option v-for="month in ['january','february','march','april','may','june','july','august','september','october','november','december']" :value="month.slice(0,3)">{{ month.replace(/^\w/, (c) => c.toUpperCase())}}</option>
                            </select>
                            <select
            ...
            <CheckOutViewCard title="Important information about your booking" 
                ...
                <BaseButton button-text="Complete Booking" class="text-[15px] leading-[20px] tracking-[0.3px] py-[12px] px-[18px] mb-[21px]" @click="changeModalState"/>
                <div class="flex justify-start">
